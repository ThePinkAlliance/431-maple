    ...
    public static final class MAXSwerveModule {
        ...
        static {
            ...
            double drivingFactor =
                    ModuleConstants.kWheelDiameterMeters * Math.PI / ModuleConstants.kDriveMotorGearRatio;
            double turningFactor = 2 * Math.PI;
            double drivingVelocityFeedForward = 1 / DriveConstants.kPhysicalMaxSpeedMetersPerSecond;
